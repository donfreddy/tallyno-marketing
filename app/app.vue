...
<template>
  <UApp>
    ...
    <footer
      class="w-full"
      style="background: #18181B; font-family: 'DM Sans', sans-serif"
    >
      <div class="max-w-6xl mx-auto px-6 py-12">
        <div class="grid sm:grid-cols-2 md:grid-cols-4 gap-8 mb-10">
            ...
            <div class="flex items-center gap-2 mb-4">
              ...
              >
                <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                  <rect x="2" y="5" width="14" height="2" rx="1" fill="white" />
                  <rect x="2" y="9" width="10" height="2" rx="1" fill="white" />
                  <rect x="2" y="13" width="12" height="2" rx="1" fill="white" />
                  <circle cx="14" cy="14" r="2.5" fill="#10B981" />
                </svg>
              </div>
              <span style="color: white; font-size: 20px; font-weight: 700; letter-spacing: -0.02em">
                Tallyno
              </span>
            </div>
            ...
            <div class="flex gap-3 mt-5">
              ...
              >
                <svg width="14" height="14" viewBox="0 0 24 24" fill="white">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.742l7.736-8.855L1.254 2.25H8.08l4.259 5.63 5.905-5.63zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                </svg>
              </a>
            </div>
          </div>
          ...
          <div>
            <p style="font-size: 12px; font-weight: 700; color: #52525B; letter-spacing: 0.08em; margin-bottom: 16px">
              PRODUIT
            </p>
            <div class="flex flex-col gap-3">
              <a v-for="l in ['Fonctionnalités', 'Comment ça marche', 'Tarifs', 'Télécharger']" :key="l" href="#" style="font-size: 14px; color: #71717A" class="hover:text-white transition-colors">
                {{ l }}
              </a>
            </div>
          </div>
          ...
          <div>
            ...
            <div class="flex flex-col gap-3">
              <a v-for="l in ['Conditions d\'utilisation', 'Politique de confidentialité', 'Contact']" :key="l" href="#" style="font-size: 14px; color: #71717A" class="hover:text-white transition-colors">
                {{ l }}
              </a>
            </div>
          </div>
