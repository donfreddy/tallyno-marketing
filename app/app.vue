...
const description =
  "Partage, suis et équilibre tes dépenses de groupe. Sans cash, sans friction.";
        ...
        <div class="grid sm:grid-cols-2 md:grid-cols-4 gap-8 mb-10">
          <div class="md:col-span-2">
            ...
            <p
              ...
              "
            >
              Ton carnet de comptes partagé, intelligent. Tu gardes le contrôle,
            ...
            <div class="flex gap-3 mt-5">
              ...
              >
                <svg width="14" height="14" viewBox="0 0 24 24" fill="white">
                  <path
                    d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.742l7.736-8.855L1.254 2.25H8.08l4.259 5.63 5.905-5.63zm-1.161 17.52h1.833L7.084 4.126H5.117z"
                  />
                </svg>
              </a>
            </div>
